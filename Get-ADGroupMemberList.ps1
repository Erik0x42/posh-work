...
{ 
    ...
    Get-ADGroupMember -Identity $ADGroupName | Get-ADUser -Properties * | Select SamAccountName, Name, UserPrincipalName | Export-Csv -Path ($ADGroupName + '.csv') -NoTypeInformation
}
